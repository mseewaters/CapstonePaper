...
data.final3 <- read.csv("NIBRS_cleaned_notfilled_1999.csv")
...
model.rf <- randomForest(target.harm ~ ., data=data.m3, mtry=10, ntree=200, strata=data.m3$type, sampsize=c(SingleVO=.72*test.num, MultVic=.13*test.num, MultOff=.12*test.num, MultVO=.025*test.num))
